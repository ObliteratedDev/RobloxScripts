local function initLibrary()
	...
	UserInputService.InputBegan:Connect(function(Input, gameProcessedEvent)
    	...
    	if Input.KeyCode == Enum.KeyCode.Insert then
			...
			if game:GetService("CoreGui").Scraper.Epic.Visible then
			game:GetService("CoreGui").Scraper.Epic.Visible = false
			else			
			game:GetService("CoreGui").Scraper.Epic.Visible = true
			end
    	end
	end)
	UserInputService.InputBegan:Connect(function(Input, gameProcessedEvent)
